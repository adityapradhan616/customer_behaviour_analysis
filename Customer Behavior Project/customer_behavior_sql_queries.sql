...
order by (select avg (review_rating)from customer) desc limit 5
...
--Q5. Do subscribed customers spend more? Compare average spend and total revenue subscribers and non-subscribers.
